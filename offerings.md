...
<div class="book-grid curriculum-grid">
  <div class="book-card">
    <h5>Gentleness, Precision, and Letting Go<span style="font-size: 0.8rem;"> (Foundations of a sustainable practice)</span></h5>
  ...
  <div class="book-card">
    <h5>World as Lover, World as Self<span style="font-size: 0.8rem;"> (Unlearning political, ecological, and spiritual dualism)</span></h5>
    <h6>4 weeks / 6 weeks</h6>
    <details><summary><strong>See more</strong></summary>
  ...
  <div class="book-card">
    <h5>We Are the Earth Defending Itself <span style="font-size: 0.8rem;"> (Empowering action by becoming one with the Earth)</span></h5>
