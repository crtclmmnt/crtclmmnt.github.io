...
<div style="position: relative; width: 100%; max-width: 850px;">
  ...
  <div style="position: absolute; bottom: 0; width: 100%; padding: 10px; box-sizing: border-box;">
    <h1 style="color: white; margin: 0; font-weight: 500; text-shadow: none; border-bottom: none;">Meditation for Liberation</h1>
  </div>
</div>
...
<br>
<h1 style="margin: 1em auto 15px auto;">Build A Meditation Practice</h1>
